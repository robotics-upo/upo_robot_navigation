...
#ifndef __UPO_PLANNER_H__
#define __UPO_PLANNER_H__
...
#include <upo_local_planner/trajectory.h>
...
namespace upo_local_planner {
  ...
  class UpoPlanner{
    ...
    public:
	  ...
	  /*UpoPlanner(WorldModel& world_model, 
	  ...
	  */
       ...
       */
	  UpoPlanner(tf::TransformListener* tf,
