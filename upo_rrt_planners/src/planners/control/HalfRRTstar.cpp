...
upo_RRT::HalfRRTstar::HalfRRTstar() : Planner() {
...
upo_RRT::HalfRRTstar::~HalfRRTstar() {

}


bool upo_RRT::HalfRRTstar::steer(Node* fromNode, Node* toNode, Node* newNode)
{
...
bool upo_RRT::HalfRRTstar::collisionFree(Node* fromNode, Node* toNode, std::vector<Action>& acts, std::vector<State>& istates, float& motCost) {
...
std::vector<upo_RRT::Node> upo_RRT::HalfRRTstar::solve(float secs)
{
...
void upo_RRT::HalfRRTstar::getNearestNeighbors(Node* node, std::vector<Node*> &nbrs) 
{
...
void upo_RRT::HalfRRTstar::calculateParamsNearest() {
...
/*float upo_RRT::RRTstar::motionCost(Node* n1, Node* n2) {
	if(space_->getDimensions() == 2) {
		//if(useKnearest_)  {
