...
upo_RRT::RRTstar::RRTstar() : Planner() {
...
upo_RRT::RRTstar::~RRTstar() {

}


bool upo_RRT::RRTstar::steer(Node* fromNode, Node* toNode, Node* newNode)
{
...
bool upo_RRT::RRTstar::collisionFree(Node* fromNode, Node* toNode, std::vector<Action>& acts, std::vector<State>& istates, float& motCost) {
...
std::vector<upo_RRT::Node> upo_RRT::RRTstar::solve(float secs)
{
...
void upo_RRT::RRTstar::getNearestNeighbors(Node* node, std::vector<Node*> &nbrs) 
{
...
void upo_RRT::RRTstar::calculateParamsNearest() {
